#!/usr/bin/python3
"""
This is a module that contains the test suite for the BaseModel class
"""
import unittest
...
class TestBaseModel(unittest.TestCase):
    ...
    def test_if_BaseModel_instance_has_id(self):
        """
        Checks that the instance has an id assigned on initialization
        """
        b = BaseModel()
    ...
    def test_ids_is_unique(self):
        """
        Checks if the id is generated randomly and uniquely
        """
        b1 = BaseModel()
        b2 = BaseModel()
    ...
    def test_type_of_id_is_str(self):
        """
        Checks that the id generated is a str object
        """
        b = BaseModel()
    ...
    def test_that_created_at_equals_updated_at_initially(self):
        """
        Checks that the create_at == updated_at at initialization
        """
        b = BaseModel()
    ...
    def test_that_save_func_update_update_at_attr(self):
        """
        Checks that the save() method updates the updated_at attribute
        """
        b = BaseModel()
        b.save()
    ...
    def test_if_to_dict_returns_dict(self):
        """
        Checks if the BaseModel.to_dict() returns a dict object
        """
        b = BaseModel()
    ...
    def test_if_to_dict_returns_class_dunder_method(self):
        """
        Checks if the BaseModel.to_dict() contains __class__
        """
        b = BaseModel()
    ...
    def test_that_created_at_returned_by_to_dict_is_an_iso_string(self):
        """
        Checks that the created_at is stored as a str obj in ISO format
        """
        b = BaseModel()
    ...
    def test_that_updated_at_returned_by_to_dict_is_an_iso_string(self):
        """
        Checks that the updated_at is stored as a str obj in ISO format
        """
        b = BaseModel()
    ...
    def test_if_to_dict_returns_the_accurate_number_of_keys(self):
        """
        Checks that the to_dict() returns the expected number of keys/values
        """
        b = BaseModel()
    ...
    def test_when_kwargs_passed_is_empty(self):
        """
        Checks that the id, created_at and updated_at are automatically
    ...
    def test_when_kwargs_passed_is_not_empty(self):
        """
        Checks that the id, created_at and updated_at are created from kwargs
        """
    ...
    def test_when_kwargs_passed_is_more_than_default(self):
        """
        Checks the BaseModel does not break when kwargs contains more than
    ...
    def test_new_method_not_called_when_dict_obj_is_passed_to_BaseModel(self):
        """
        Tests that the storage.new() is not called when a BaseModel obj is
    ...
    def test_that_save_method_updates_updated_at_attr(self):
        """
        Checks that the save() method updates 'updated_at' attribute
        """
        b = BaseModel()
        sleep(0.02)
    ...
    def test_save_update_file(self):
        """
        Tests if the file is updated when the 'save' is called
        """
        b = BaseModel()
        b.save()
    ...
    def test_that_to_dict_contains_correct_keys(self):
        """
        Checks whether the to_dict() returns the expected key
        """
    ...
    def test_to_dict_contains_added_attributes(self):
        """
        Checks that the new attributes are also returned by to_dict()
        """
        b = BaseModel()
        attrs = ["id", "created_at", "updated_at", "__class__"]
        b.name = "Firdaus"
    ...
    def test_to_dict_with_args(self):
        """
        Checks that the TypeError is returned when argument is passed to to_dict()
        """
        b = BaseModel()
